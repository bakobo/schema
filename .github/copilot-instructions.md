...
- **Sibling-repo references in AGENTS.md are intentional.** Paths like `../x/`, `../y/`, or any other `../sibling/` pattern are cross-repository references to sibling repos on disk and on GitHub. They are not broken local links. Do not flag them.
